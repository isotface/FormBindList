...
namespace MyDebug
{
	public partial class FormVarBindList : Form
	{
		...
		public void AddList<T>(IList<T> list)
		{
			...
			var listData = new VarList<T>(list);
		...
		public void UpdateList(int idx)
		{
			...
			m_listBindSrc[idx].ResetBindings(false);
